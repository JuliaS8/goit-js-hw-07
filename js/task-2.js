...
// Напиши скрипт для створення галереї зображень на основі масиву даних.HTML містить
// список ul.gallery. <ul class="gallery"></ul>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const galleryItems = images.map(({ url, alt }) => {
    ...
    img.alt = alt;
    li.appendChild(img);
    li.style.flex = '1 1 calc(33.33% - 15px)';
